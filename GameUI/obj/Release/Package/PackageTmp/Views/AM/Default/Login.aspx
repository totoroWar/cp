...
<body style="background:#edf4f9" class="txt_center ">
<style type="text/css">
...
<div name="Header">
  <div style="height:46px; margin-top: 20px;" class="wd getuserdata" id="topDataTd">
    ...
    <div class="topLink right addrtitle"><a href="#" class="toptitle" >新用户注册</a><span style="color:#798699"> | </span><a href="#" class="toptitle" >客户端收发</a><span style="color:#798699"> | </span><a href="#" class="toptitle" >English</a><span style="color:#798699"> | </span><a href="#" class="toptitle">繁体版</a></div>
  </div>
</div>
              ...
              <div class="loginContent" style="">
                ...
                <div id="loginby_account" >
                  ...
                  <div style="height:25px;">
                    ...
                    <input class="txt text" type="text" id="inputuin" name="a" value="" tabindex="1" style="ime-mode:disabled;"/>
                  </div>
                  <div style="height:25px;margin:10px 0 0 0;clear:left;margin:0;">
                    <label for="inputpassword" class="column" >密　码：</label>
                    <input type="password" id="inputpassword" name="p" value="" tabindex="2" class="txt text" />
                  </div>
                  <div style="margin:8px 0 0 0; margin:0;">
                    <div style="height:25px">
                      <label for="vc" class="column" >验证码：</label>
                      <input type="text" id="vc" name="vc" value="" tabindex="3" style="ime-mode: disabled;" autocomplete="off" class="txt text" />
                    </div>
...
<script type="text/javascript">
    function cv()
    {
        document.getElementById("vimg").src = "/AM/VCode?random="+Math.random();
    }
</script>
</body>
</html>