...
<head runat="server">
    ...
    <style type="text/css">
      ...
      body {font-family: Georgia, "Times New Roman", Times, serif; font-family:Verdana; text-align: center;}
      table {margin-left: auto; margin-right: auto; text-align: left; border-collapse: collapse; border:0; width:100%;}
      td, th {border: 1px solid #000000; font-size: 75%; vertical-align: baseline; vertical-align:auto;}
      .title {font-size: 150%;}
      .section {text-align: center;}
      .header {text-align: center; background-color: #9999cc; font-weight: bold; color: #000000;}
      .name {background-color: #ccccff; font-weight: bold; color: #000000; width:200px;}
      .value {background-color: #cccccc; color: #000000; word-break: break-all;}
