						        ...
						        success: function (data)
						        {
						            ...
						            try
						            {
						                ...
						                else
						                {
						                    ...
						                    var traceOrder = data.project.taskid != 0 ? ("<a href=\"" + "javascript:window.parent.parent.ui_show_tab('" + data.project.tiissuestart.toString() + "_" + data.project.taskid + "追号'," + "'/UI/Record?method=orderTraceDetail&key=" + data.project.taskid.toString() + "',true,true);\" style=\"color:#f00;\">" + "追号详情</a>") : "";
