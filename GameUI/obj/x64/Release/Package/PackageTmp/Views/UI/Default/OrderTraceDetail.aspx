...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table-pro tp5 w100ps">
        <tr>
            <td class="title">追号单号</td>
            <td><%:traceObject.TraceOrder.sto001 %></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><%:traceObject.TraceOrder.sto004.ToString(ViewContext.ViewData["SysDateTimeFormat"].ToString()) %></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><%:traceObject.TraceOrder.sto002.ToString(ViewContext.ViewData["SysMoneyFormat"].ToString())%></td>
        </tr>
        <tr>
            <td class="title">实际金额</td>
            <td><%:traceObject.TraceOrder.sto007.ToString(ViewContext.ViewData["SysMoneyFormat"].ToString())%></td>
        </tr>
        <tr>
            <td class="title">奖金</td>
            <td><%:traceObject.TraceOrder.sto008.ToString(ViewContext.ViewData["SysMoneyFormat"].ToString())%></td>
        </tr>
        <tr>
