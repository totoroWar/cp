...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%
        ...
        发起账号<input type="text" class="input-text w100px" name="account" value="<%:ViewData["Account"] %>" />
    ...
    <table class="table-pro table-color-row tp5" width="100%">
        ...
        <tbody>
            ...
            <tr key="<%:item.sco001 %>">
                ...
                <td class="dom-hide"><%:item.gs007 == null ? string.Empty : item.gs007.Trim() %></td>
    ...
    <%=ViewData["PageList"] %>
    <div id="e_join" class="dom-hide w400px">
    ...
    <script type="text/javascript">
        function combine_join(key)
        {
            ...
            $.ajax({
                timeout: _global_ajax_timeout, cache: false, type: "POST", data: { method: "getCombine", key: key }, url: "/UI/Combine", success: function (a) {
                    _check_auth(a);
                    var _robj = eval(a);
                    if (0 == _robj.Code)
                    {
