...
<table class="table-pro tp5 w100ps">
        ...
        <tbody>
            ...
            <tr>
              <%
                      //(奖金金额+返点金额+分红金额+系统充值)-(下注+提现+回收金额+充值手续费+提现手续费)
                      decimal lineSum = (item.dr006 + item.dr007 + item.dr016 + item.dr011) - (item.dr004 + item.dr010 + item.dr012 + item.dr014 + item.dr015);
