...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog1"],parse:function(_2){
var aa=[];
...
_262.panel({border:false,doSize:false,bodyCls:"dialog1-content"});
return _262;
};
function _263(_264){
var opts=$.data(_264,"dialog1").options;
var _265=$.data(_264,"dialog1").contentPanel;
if(opts.toolbar){
if($.isArray(opts.toolbar)){
$(_264).find("div.dialog1-toolbar").remove();
var _266=$("<div class=\"dialog1-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_264);
var tr=_266.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
$("<td><div class=\"dialog1-tool-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
...
$(opts.toolbar).addClass("dialog1-toolbar").prependTo(_264);
$(opts.toolbar).show();
}
}else{
$(_264).find("div.dialog1-toolbar").remove();
...
$(_264).find("div.dialog1-button").remove();
var _267=$("<div class=\"dialog1-button\"></div>").appendTo(_264);
...
$(opts.buttons).addClass("dialog1-button").appendTo(_264);
$(opts.buttons).show();
}
}else{
$(_264).find("div.dialog1-button").remove();
...
_265.panel("resize",{width:_26d.width(),height:(_26c=="auto")?"auto":_26d.height()-_26d.children("div.dialog1-toolbar")._outerHeight()-_26d.children("div.dialog1-button")._outerHeight()});
if(opts.onResize){
...
var _270=$.data(_26f,"dialog1").contentPanel;
_270.panel("refresh",href);
};
$.fn.dialog1=function(_271,_272){
if(typeof _271=="string"){
var _273=$.fn.dialog1.methods[_271];
if(_273){
...
_271=_271||{};
return this.each(function(){
var _274=$.data(this,"dialog1");
if(_274){
$.extend(_274.options,_271);
}else{
$.data(this,"dialog1",{options:$.extend({},$.fn.dialog1.defaults,$.fn.dialog1.parseOptions(this),_271),contentPanel:_260(this)});
}
_263(this);
});
};
$.fn.dialog1.methods={options:function(jq){
var _275=$.data(jq[0],"dialog1").options;
...
var _277=$.data(jq[0],"dialog1").contentPanel;
return _275;
},dialog1:function(jq){
...
$.fn.dialog1.parseOptions=function(_278){
return $.extend({},$.fn.window.parseOptions(_278),$.parser.parseOptions(_278,["toolbar","buttons"]));
};
$.fn.dialog1.defaults=$.extend({},$.fn.window.defaults,{title:"New dialog1",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:"24",selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_353){
